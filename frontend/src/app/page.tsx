  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        {/* ── Hero Section ──────────────────────────────────────────────────── */}
        <section className="relative bg-gray-950 text-white overflow-hidden py-20 lg:py-32">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              ...
              <div className="space-y-6 max-w-xl">
                <p className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-800 text-xs font-semibold tracking-wider text-gray-300 uppercase">
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />
                  New Collection — 2026
                </p>
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-[1.1] text-white">
                  Crafted for <br />
                  <span className="text-gray-400 font-light">Excellence & Style.</span>
                </h1>
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  <Link
                    href="/products"
                    className="inline-flex items-center gap-2 px-6 py-3.5 bg-white text-gray-950 text-sm font-semibold rounded-full hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 duration-200"
                  >
                    Shop Collection
                  ...
                  <a
                    href="#categories"
                    className="inline-flex items-center px-6 py-3.5 border border-gray-700 text-sm font-semibold text-gray-300 rounded-full hover:border-gray-500 hover:text-white transition-all duration-200"
                  >
                    Browse Categories
                  </a>
                </div>
              ...
              <div className="relative flex justify-center lg:justify-end">
                <div className="relative w-full max-w-md aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border border-gray-800">
                  <Image
                ...
                <div className="absolute -left-6 top-1/4 bg-white/95 backdrop-blur-md text-gray-900 px-4 py-3 rounded-2xl shadow-xl flex items-center gap-3 border border-gray-100/20 animate-bounce duration-1000" style={{ animationDuration: '6s' }}>
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-medium">From 12k+ Customers</p>
                  </div>
                </div>

                {/* Floating Badge 2: Bestseller overlay */}
                <div className="absolute -right-4 bottom-1/4 bg-gray-900/95 backdrop-blur-md text-white px-4 py-3.5 rounded-2xl shadow-xl flex items-center gap-3 border border-gray-800 animate-bounce" style={{ animationDuration: '5s' }}>
                  <span className="flex h-3.5 w-3.5 relative">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-blue-500"></span>
                  </span>
                  <div>
                    <p className="text-xs font-bold text-white leading-tight">Bestseller Item</p>
                    <p className="text-[10px] text-gray-400 font-medium mt-0.5">Top trending this week</p>
                  </div>
                </div>
              </div>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                {categories.map((cat) => {
                  ...
                  const displayDesc = cat.description === 'Seeded from DummyJSON' 
                    ? `${num} Products` 
                  ...
                  return (
                    <Link
                      ...
                      className="group relative flex flex-col justify-end bg-gray-50 hover:bg-white rounded-2xl border border-gray-100 hover:border-gray-200 p-6 h-36 overflow-hidden transition-all hover:shadow-lg hover:-translate-y-1 duration-300"
                    >
                      {/* Gradient overlay pattern */}
                      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,#e0f2fe_0%,transparent_60%)] group-hover:opacity-100 opacity-60 transition-opacity" />
